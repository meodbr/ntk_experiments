...
In this note, we perform a small empirical investigation of this question on simple multilayer perceptrons trained on the handwritten digits dataset.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/accuracy_vs_width.png}
    \caption{
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/parameter_drift.png}
    \caption{
    Parameter drift during training for different network widths.
    }
    \label{fig:drift}
\end{figure}

We observe that wider networks exhibit smaller relative parameter movement during optimization.

% -------------------------------------------------
\subsection{Kernel Stability}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/kernel_drift.png}
    \caption{
    Evolution of the empirical NTK during training.
    }
    \label{fig:kernel}
\end{figure}

The empirical NTK becomes increasingly stable as width grows, consistent with the NTK regime.
